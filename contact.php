...
$email_expediteur = 'anthony@pixelzone.fr';
$nom_expediteur = 'Anthony';
...
$destinataire = 'anthony@pixelzone.fr';
...
else
{
	...
	$objet   = 'Message depuis pixelzone.fr';
	...
	if (($nom != '') && ($email != '') && ($objet != '') && ($message != ''))
	{
		...
		{
			echo '<p>'.$message_envoye.'<br /><a href="/#contact">Retour à la home</a></p>';
		}
		else
		{
			echo '<p>'.$message_non_envoye.'<br /><a href="/#contact">Retour à la home</a></p>';
		};
	}
	else
	{
